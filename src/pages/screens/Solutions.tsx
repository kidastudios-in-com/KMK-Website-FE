...
const Solutions = () => {
	...
	return (
		<section
			id="solutions"
			style={{ backgroundColor: "#fff", paddingBottom: 50, paddingLeft: 50, paddingRight: 50 }}
		>
			<div>
				<div
								...
								<div style={{ marginTop: 10 }}>
									...
									>
										<Avatar
											...
											alt="Avatar"
											style={{ width: 95, height: 90, marginRight: 20, marginLeft: 20 }}
										/>
										<div>
											<Text b size={30}> Ramuel Smith </Text>
											<div
